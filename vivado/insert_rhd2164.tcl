...
add_files -fileset constrs_1 -norecurse "$RHD2164_SPI_ROOT/vivado/$BOARD/rhd2164-spi.xdc"
...
set_property -dict [list CONFIG.C_GPIO_WIDTH {1} CONFIG.C_IS_DUAL {1} CONFIG.C_ALL_INPUTS_2 {1} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_ALL_OUTPUTS_2 {0}] [get_bd_cells axi_gpio_status]
...
create_bd_port -dir I -type data i_miso
create_bd_port -dir O -type data o_mosi
create_bd_port -dir O -type data o_cs
create_bd_port -dir O -type data o_sclk
